...
// --- DEFINED ORDER CONSTANT (Matches Gallery.js) ---
const ALBUM_ORDER = [
    "Classrooms",
    "Labs",
    "Library",
...
const EditGallery = () => {
    ...
    const handleCreateAlbum = async (e) => {
        ...
        try {
            ...
            setNewAlbumCover('');
            setNewAlbumAlt('');
            fetchAlbums(); // Re-fetch to see it sorted in the list
        } catch (error) {
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '30px' }}>
                    <div style={styles.card}>
                        ...
                        <form onSubmit={handleCreateAlbum}>
                            ...
                            <input type="text" value={newAlbumTitle} onChange={e => setNewAlbumTitle(e.target.value)} style={styles.input} placeholder="e.g. Labs" />
