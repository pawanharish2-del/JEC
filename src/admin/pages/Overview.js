        ...
        <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div style={styles.statsGrid}>
                <div style={styles.statCard}>
                    ...
                    <Link to="/admin/manage-blogs" style={styles.link}>Manage Blogs &rarr;</Link>
                </div>
                ...
                <div style={styles.statCard}>
                    ...
                    <Link to="/admin/manage-faculty" style={styles.link}>Manage Faculty &rarr;</Link>
                </div>
            </div>
            ...
            <div style={styles.contentGrid}>
                ...
                <div style={styles.section}>
                    ...
                    <Link to="/admin/manage-blogs" style={styles.viewAllBtn}>View All Blogs</Link>
                </div>
                ...
                <div style={styles.section}>
                    ...
                    <Link to="/admin/manage-faculty" style={styles.viewAllBtn}>View All Faculty</Link>
                </div>
