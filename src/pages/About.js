    ...
    return (
        <div className="about-page-new">
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Discover Jaipur Engineering College (JEC), established in 2000. A hub for innovation, research, and holistic development with 12,000+ global alumni and state-of-the-art infrastructure in Kukas, Jaipur."
                />
            </Helmet>
            ...
            {/* --- STRATEGIC PRINCIPLES (Replaced Mission/Banner sections) --- */}
            ...
            <section className="features card-section alt-background" id="features">
                <div className="max-width-container">
                    ...
                    <div className="features-list">
                        ...
                        <div className="feature-item"><p>Excellent campus placements, including the <strong>highest package in Rajasthan of 1.56cr</strong>.</p></div>
