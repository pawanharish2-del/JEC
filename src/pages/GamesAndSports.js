// src/pages/GamesAndSports.js
import React from 'react';
import './GamesAndSports.css';
    ...
    <div className="games-page">
      ...
      <div className="container">
        ...
        <div className="facility-grid">
            ...
            <div className="fac-badge"><i class="fas fa-baseball-ball"></i> Cricket</div>
        ...
        <div className="achievements-wrapper">
            <div className="win-card">
                ...
                <ul className="win-list">
                    ...
                    <li><span className="win-year">2014</span> <span class="win-desc">I Position - Kabaddi (at RTU)</span></li>
        ...
        <div className="team-grid">
            ...
            <div className="team-card">
                ...
                <div className="team-body">
                    <div class="played-at">Played At:</div>
