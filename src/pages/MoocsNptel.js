...
const MoocsNptel = () => {
    ...
    return (
        <div className="moocs-nptel-page">
            <Helmet>
                <title>MOOCs: NPTEL & SWAYAM | JEC</title>
                <meta
                    name="description"
                    content="Access MOOCs through NPTEL and SWAYAM at JEC. Explore online courses, credit transfers, and certifications."
                />
            </Helmet>
        ...
        <div className="section-split animated-section">
          ...
          <div className="img-block">
            <img src="https://firebasestorage.googleapis.com/v0/b/jec-website-55397.firebasestorage.app/o/images%2FNPTL.png?alt=media&token=e31b80d0-8fda-4c33-b56e-1e6dedf79385" alt="Students Learning Online" />
                ...
                {/* Split View: Video & About NPTEL */}
                <div className="section-split animated-section" style={{ marginBottom: '3rem' }}>
                    <div className="img-block">
                        <a href="https://youtu.be/Hr6MJcSR9dQ" target="_blank" rel="noopener noreferrer" style={{ position: 'relative', display: 'block', height: '100%' }}>
                            <img src="https://img.youtube.com/vi/Hr6MJcSR9dQ/maxresdefault.jpg" alt="NPTEL Video" style={{ opacity: 0.9, minHeight: '300px', objectFit: 'cover' }} />
