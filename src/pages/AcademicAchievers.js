// src/pages/AcademicAchievers.js
import React from 'react';
import './AcademicAchievers.css';
...
const AcademicAchievers = () => {
  return (
    <div className="academic-achievers-page">
      ...
      {/* Optional: Add a Subheader for navigation context */}
      {/* <Subheader title="Academic Achievers" parent="JEC" /> */}
