...
// Ensure these files exist in src/assets/pdfs/
import EOA25_26 from '../assets/pdfs/EOA_Report_2025_26.pdf';
import EOA24_25 from '../assets/pdfs/EOA_Report_2024_25.pdf';
import Affiliation24_25 from '../assets/pdfs/Affiliation_2024_25.pdf';
import Affiliation21_24 from '../assets/pdfs/Affiliation_2021_24.pdf';
        ...
        <div className="md-page">
            ...
            <div className="md-container">
                ...
                <div className="md-downloads-grid">
                    {/* New 2025-26 Report */}
                    <a href={EOA25_26} target="_blank" rel="noreferrer" className="md-file-card">
                        <div className="md-file-icon-box"><i className="fas fa-file-pdf"></i></div>
                        <div className="md-file-info">
                            <span className="md-file-name">EOA Report 2025-26</span>
                    ...
                    {/* New 2024-25 Report */}
                    <a href={EOA24_25} target="_blank" rel="noreferrer" className="md-file-card">
                        <div className="md-file-icon-box"><i className="fas fa-file-pdf"></i></div>
                        <div className="md-file-info">
                            <span className="md-file-name">EOA Report 2024-25</span>
                            <span className="md-file-meta">PDF Document</span>
                        </div>
                        <i className="fas fa-download md-download-arrow"></i>
                    </a>
                ...
                <div className="md-downloads-grid">
                    {/* New Affiliation 2024-25 */}
                    <a href={Affiliation24_25} target="_blank" rel="noreferrer" className="md-file-card">
                        ...
                        <div className="md-file-info">
                            <span className="md-file-name">Affiliation 2024-25</span>
                            <span className="md-file-meta">RTU Kota</span>
                        </div>
                        <i className="fas fa-download md-download-arrow"></i>
                    </a>

                    {/* New Affiliation 2021-24 */}
                    <a href={Affiliation21_24} target="_blank" rel="noreferrer" className="md-file-card">
                        <div className="md-file-icon-box" style={{ background: 'rgba(0,114,198,0.1)', color: 'var(--md-primary)' }}><i className="fas fa-university"></i></div>
                        <div className="md-file-info">
                            <span className="md-file-name">Affiliation 2021-24</span>
                            <span className="md-file-meta">RTU Kota</span>
                        </div>
                        <i className="fas fa-download md-download-arrow"></i>
                    </a>
