    ...
    return (
        <div className="courses-offered-page">
            ...
            <div className="college-side-bar">
                <a href="tel:+91123456789"><i className="fas fa-phone"></i><span>Helpline</span></a>
                <a href="/brochure.pdf"><i className="fas fa-file-pdf"></i><span>Brochure</span></a>
                <a href="/admissions"><i className="fas fa-graduation-cap"></i><span>Admissions</span></a>
                <a href="/events"><i className="fas fa-calendar"></i><span>Events</span></a>
                <a href="https://wa.me/91123456789"><i className="fab fa-whatsapp"></i><span>WhatsApp</span></a>
            </div>
            ...
            <div className="max-width-container content-section">
                ...
                <h2 className="section-title" style={{ borderColor: 'var(--logo-red)' }}>2. Lateral Entry (Direct 2nd Year)</h2>
                ...
                <div className="course-grid">
                    ...
                    <div className="course-card mtech">
                        <h3>Environmental Engineering <span style={{ color: 'var(--logo-red)', marginLeft: '5px' }}>*</span></h3>
                        <span className="duration">18 Seats</span>
                ...
                <div className="karma-section">
                    ...
                    <p className="text-block">AICTE's "Kaushal Augmentation and Restructuring Mission" (KARMA) integrates vocational education. JEC offers various skill courses under this scheme.</p>
                    ...
                    <a href="https://jeckukas.org.in/admission/Skill-Courses-JEC" style={{ color: 'var(--logo-blue)', fontWeight: 'bold', marginTop: '15px', display: 'inline-block' }}>View 24 KARMA Courses &rarr;</a>
                </div>

                <h2 className="section-title" style={{ marginTop: '60px', borderColor: 'var(--logo-gold)' }}>6. "SURYAMITRA" Skill Development Programme</h2>
                <div className="text-block">
                ...
                <h2 className="section-title" style={{ marginTop: '60px', borderColor: 'var(--logo-blue)' }}>7. "VAYUMITRA" Skill Development Program (VSDP)</h2>
                <div className="text-block">
                ...
                <h2 className="section-title" style={{ marginTop: '60px' }}>Career Opportunities</h2>
                <div className="text-block">
